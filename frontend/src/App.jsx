...
function App() {
    ...
    <div className="site-shell">
      <header className="site-header">
        ...
        <div className="header-badge">
          <Zap size={17} />
          <div><strong>Профи-аналитика</strong><span>AI + реальные данные</span></div>
        </div>
      </header>
      ...
      <main id="top" className={`page-wrap ${activePage !== "home" ? "page-hidden" : ""}`}>
        <section className="hero-panel">
          <div className="hero-copy">
            ...
            <h1><span>Больше,</span> чем просто прогнозы</h1>
            <p>Анализируем форму, xG, коэффициенты и рынок. Находим ценность до того, как она исчезнет.</p>
  ...
  <small>{prettyBetDescription(bet)}</small>
            ...
            <footer className="site-footer"><div className="footer-brand"><LogoMark /><strong>FootballAI</strong></div><span>Футбол — это больше, чем игра. Это данные. Это возможности.</span><span>{result?.version || "Football AI Analyst"}</span></footer>
          </div>
        ) : null}
      </main>
